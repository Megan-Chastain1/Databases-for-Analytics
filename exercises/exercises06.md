...
![Star Schema Diagram][Screenshots/ex06_schema.png]
...
My design is banking on some transformations before loading into the warehouse. I need to convert customer addresses to zipcodes instead of full addresses (city, state, year). I didn't want to include full addresses because that's erroneous information and would take up too much space. I also decided to have month, day, year individual from eachother to make queries easier for me to view. Another set of transformations I would make would be to total the sales and quantities sold/part. This will make queries for averages easier to write. I think this will also ake it easier to find total sales and quantities sold per day.

I believe this schema design will also query well for sales/individual customers or individual parts, as I kept the order table information as my primary keys.
